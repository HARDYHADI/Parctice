...
let turn_player = 0, player_card = 0, dealer_card = 0, winner; //현재 턴 주인공
...
let standing = false, turnEnd = false, gameOver = false;   //stand 버튼 눌렀을 떄 활성화, 딜러 턴 끝났을때 활성화
let BlackJack = {
...
//딜러 턴으로 , 딜러의 턴이 종료되어도 스탠드 함수를 호출할 수 있고 이로인해 점수판이 오류가 남
function Stand() {
  if(!turnEnd){
    console.log('stand');
    standing = true;
